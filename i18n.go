...
var findingMessages = map[string]translations{
	...
	"github-pull-request-operation-unknown": {"A dynamic or custom GitHub operation was not allowed automatically because it could create a pull request.", "pull requestを作成する可能性がある動的またはカスタムのGitHub操作は自動では許可しませんでした。"},
